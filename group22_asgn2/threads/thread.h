...
class NachOSThread {
  ...
  public:
    ...
    NachOSThread(char* threadName, int pty);
    ...
    void setPPID(int newPPID){ppid = newPPID;}

    void statThreadUpdate(char a);

    static int totalNumberOfThreads;
