...
NachOSThread* globalThread[MAX_THREADS];             //thread array of running thread
...
TimerInterruptHandler(int dummy)
{
    ...
    if( WaitingList->LeastTime() <= stats->totalTicks)
	{
		NachOSThread* ToBeAdded = (NachOSThread*)(WaitingList->SortedRemove(NULL));
		scheduler->MoveThreadToReadyQueue(ToBeAdded);
	}
